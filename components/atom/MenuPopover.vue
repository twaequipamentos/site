<template>
  <nav>
    <ul>
      <li>
        <a href="#" @click.prevent="goToPage('quem-somos')" class="highlight-menu text-uppercase text-sm">{{$t('menu.whoWeAre')}}</a>
      </li>
      <li>
...
<style lang="scss">
    ...
    nav a::after {
      ...
      background: red; /* cor do underline */
      transform: scaleX(0);
    ...
    nav .highlight-menu:hover::after {
      transform: scaleX(1);
